	...
	<p><a id="more" class="btn btn-default" href="/ReefCoralPi/lighting" role="button">View details �</a></p>
      ...
      <div class="row" >
        <div id="comp_box" class="col-md-4">
          <h2>Circulators</h2>
          <p><table>
		  <tr><td>Circulator #1</td><td style="text-align: center;"><input type="checkbox" id="toggle-button5" checked ></td></tr>
	     <tr><td>Circulator #2</td><td style="text-align: center;"><input type="checkbox" id="toggle-button6" ></td></tr>
		 </table></p>
        </div>      
